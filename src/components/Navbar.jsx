...
<h3 onClick={() => navigate('/')} className="nav-title">
  <img 
    src="https://api.sherbert.cimpress.io/v2/assets/-L04orNssTOE3rPXFZBvj~200/webPreview?signature=b3f827f32c4b3e872930b1032ac874a8d1568745" 
    alt="Spicy Selection Logo" 
    className="nav-logo"
  />
 Spicy Selection
</h3>
